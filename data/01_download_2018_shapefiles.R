...
# The other script (01_download_shapefiles.R) downloads and builds the national shapefile
# as instructed by: https://www.aec.gov.au/electorates/gis/files/build-2016-national-dataset.pdf

# This script downloads the most recent shapefile for each state and combines them.
# Upside: most recent boundaries
# Downside: Some of the states look a bit wonky (QLD in particular)
