...
file_list <- file_list[c(3, 7, 9, 12)]
...
# Export and clean up -----------------------------------------------------
write_sf(electorates, here::here("data", "electorates.gpkg"))
...
test <- read_sf(here::here("data", "electorates.gpkg")) %>% rename(geometry = geom)
...
# To do
# Go back and do Nat data as they want me to (use 2016 for ACT)
# Prettify map
